(function (factory) {
    ...
    class Repulser extends tsparticles_engine_1.ExternalInteractorBase {
        ...
        isEnabled() {
            const container = this.container, options = container.actualOptions, mouse = container.interactivity.mouse, events = options.interactivity.events, divs = events.onDiv, divRepulse = (0, tsparticles_engine_1.isDivModeEnabled)("repulse", divs);
        ...
        clickRepulse() {
            ...
            if (container.repulse.clicking) {
                ...
                const range = new tsparticles_engine_1.Circle(mouseClickPos.x, mouseClickPos.y, repulseRadius), query = container.particles.quadTree.query(range);
                for (const particle of query) {
