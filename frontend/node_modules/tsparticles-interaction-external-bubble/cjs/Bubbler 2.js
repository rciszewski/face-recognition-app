...
class Bubbler extends tsparticles_engine_1.ExternalInteractorBase {
    ...
    isEnabled() {
        const container = this.container, options = container.actualOptions, mouse = container.interactivity.mouse, events = options.interactivity.events, divs = events.onDiv, divBubble = (0, tsparticles_engine_1.isDivModeEnabled)("bubble", divs);
    ...
    singleSelectorHover(selector, div) {
        ...
        selectors.forEach((item) => {
            const elem = item, pxRatio = container.retina.pixelRatio, pos = {
                ...
                : new tsparticles_engine_1.Rectangle(elem.offsetLeft * pxRatio, elem.offsetTop * pxRatio, elem.offsetWidth * pxRatio, elem.offsetHeight * pxRatio), query = container.particles.quadTree.query(area);
    ...
    hoverBubbleColor(particle, ratio, divBubble) {
        ...
        if (!particle.bubble.finalColor) {
            ...
            particle.bubble.finalColor = (0, tsparticles_engine_1.colorToHsl)(bubbleColor);
        }
        if (!particle.bubble.finalColor) {
            return;
        }
