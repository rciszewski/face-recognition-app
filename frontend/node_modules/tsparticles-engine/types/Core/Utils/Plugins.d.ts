...
declare type GenericInitializer<T> = (container: Container) => T;
declare type InteractorInitializer = GenericInitializer<IInteractor>;
declare type MoverInitializer = GenericInitializer<IParticleMover>;
declare type UpdaterInitializer = GenericInitializer<IParticleUpdater>;
