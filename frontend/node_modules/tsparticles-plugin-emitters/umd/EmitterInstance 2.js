    ...
    class EmitterInstance {
        constructor(engine, emitters, container, options, position) {
            ...
            if (this.options.spawnColor) {
                this.spawnColor = (0, tsparticles_engine_1.colorToHsl)(this.options.spawnColor);
            }
        ...
        emitParticles(quantity) {
            ...
            for (let i = 0; i < quantity; i++) {
                const particlesOptions = (0, tsparticles_engine_1.deepExtend)({}, this.particlesOptions);
                if (this.spawnColor) {
