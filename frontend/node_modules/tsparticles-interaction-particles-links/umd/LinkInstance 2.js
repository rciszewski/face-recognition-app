    ...
    class LinkInstance {
        ...
        drawLinkTriangle(p1, link1, link2) {
            ...
            container.canvas.draw((ctx) => {
                ...
                let colorTriangle = (0, tsparticles_engine_1.colorToRgb)(triangleOptions.color);
                if (!colorTriangle) {
        ...
        drawLinkLine(p1, link) {
            ...
            container.canvas.draw((ctx) => {
                ...
                if (twinkle.enable) {
                    const twinkleFreq = twinkle.frequency, twinkleRgb = (0, tsparticles_engine_1.colorToRgb)(twinkle.color), twinkling = Math.random() < twinkleFreq;
