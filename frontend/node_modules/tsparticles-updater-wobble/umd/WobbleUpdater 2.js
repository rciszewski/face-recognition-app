        ...
        init(particle) {
            ...
            if (wobbleOpt.enable) {
                particle.wobble = {
                    ...
                    speed: (0, tsparticles_engine_1.getRangeValue)(wobbleOpt.speed) / 360,
                };
            }
            else {
                particle.wobble = {
            ...
            particle.retina.wobbleDistance = (0, tsparticles_engine_1.getRangeValue)(wobbleOpt.distance) * this.container.retina.pixelRatio;
        }
        isEnabled(particle) {
